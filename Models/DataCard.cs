...
namespace SMARTV3.Models
{
    public partial class DataCard
    {
        ...
        public virtual ICollection<DataCardPETS> DataCardPETS { get; set; } = new HashSet<DataCardPETS>();
        public virtual ICollection<CapabilityDataCard> CapabilityDataCards { get; set; } = new HashSet<CapabilityDataCard>();
    }
}
